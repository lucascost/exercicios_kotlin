...
class Detalhes : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Ações
        b.selecP.setOnClickListener(){ configButtons(b.selecP) }
        b.selecM.setOnClickListener(){ configButtons(b.selecM) }
        b.selecG.setOnClickListener(){ configButtons(b.selecG) }

        b.btnMais.setOnClickListener(){quantidade++; b.txtQuantidade.text = quantidade.toString()}
        b.btnMenos.setOnClickListener(){quantidade--; b.txtQuantidade.text = quantidade.toString()}
    }
